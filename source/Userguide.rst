...
The admin of the system has the following tasks to perform:

    #. Managing users of the system
    #. Managing reports to be generated by the system
    #. Managing stocks data that is used to generate reports



The normal user of the system
###############################
The main task of the normal user is to view reports generated by the system and make use of them.
